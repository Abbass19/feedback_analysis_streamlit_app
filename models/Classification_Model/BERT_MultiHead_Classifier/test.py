...
# FIXED: Use "resolve" for direct download
MODEL_URL = "https://huggingface.co/abbasszahreddine/feedback-classifier-model/resolve/main/feedback_classifier.pt"
TOKENIZER_URL = "https://huggingface.co/abbasszahreddine/feedback-classifier-model/resolve/main/saved_model.zip"
CONFIG_URL = "https://huggingface.co/abbasszahreddine/feedback-classifier-model/resolve/main/model_config.json"
...
def ensure_model():
    ...
    if not os.path.exists(TOKENIZER_PATH):
        ...
        with zipfile.ZipFile(zip_path, 'r') as zip_ref:
            zip_ref.extractall(os.path.dirname(TOKENIZER_PATH))
        os.remove(zip_path)
